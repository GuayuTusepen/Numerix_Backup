        ...
        <div className="relative z-20 flex flex-col justify-between h-full text-white min-h-[220px]">
          <CardHeader className="flex flex-row items-center space-x-4 p-4">
              ...
              <div className="flex-1">
                <CardTitle className="text-lg font-bold font-zto [text-shadow:2px_2px_4px_rgba(0,0,0,0.9)]">{lesson.title}</CardTitle>
          ...
          <CardContent className="p-4 pt-0">
             <CardDescription className="text-sm text-white/95 mb-3 min-h-[40px] font-zto [text-shadow:2px_2px_4px_rgba(0,0,0,0.9)]">{lesson.description}</CardDescription>
